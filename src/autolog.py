...
mlflow.autolog() # using this to avoid doing manually
# You can log them in other experiment if it is already created like this
mlflow.set_experiment('EXP1') # if it is not created then code will create this
with mlflow.start_run():
    ...
    mlflow.log_artifact(__file__)# loging the code as the file(script) not autologed
